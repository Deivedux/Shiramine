...
c = conn.cursor()
c.execute("CREATE TABLE IF NOT EXISTS ServerConfig (Guild INTEGER unique, Prefix TEXT, Language TEXT, ImgFilter INTEGER, AntiInvite INTEGER, AntiURL INTEGER, GreetMsg TEXT, GreetChannel INTEGER, GreetDel INTEGER, GreetToggle INTEGER, LeaveMsg TEXT, LeaveChannel INTEGER, LeaveDel INTEGER, LeaveToggle INTEGER, GreetDmMsg TEXT, GreetDmToggle INTEGER)")
...
startup_extensions = ['cogs.Events', 'cogs.Administration', 'cogs.Help']
